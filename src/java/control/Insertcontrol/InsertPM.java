 ...
 * @author ASUS
 */
@WebServlet(name = "InsertPM", urlPatterns = {"/insertpm"})
public class InsertPM extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertPM</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertPM at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String docgia = request.getParameter("docgia");
        
        PHIEUMUONDAO dao = new PHIEUMUONDAO();
        dao.InsertPM(ngaymuon, ngaytra, nhanvien, docgia);
