 ...
 * @author ASUS
 */
@WebServlet(name = "SearchTK", urlPatterns = {"/searchTK"})
public class SearchTK extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SearchTK</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SearchTK at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String tentk = request.getParameter("search");
        
        TAIKHOANDAO dao = new TAIKHOANDAO();
        List<TAIKHOAN> listtk = dao.SearchByName(tentk);
        ...
        request.setAttribute("searchTK", tentk);
