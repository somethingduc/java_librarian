...
public class UpdateCV extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String macv = request.getParameter("sid");
        CHUCVUDAO dao = new CHUCVUDAO();
        CHUCVU cv = dao.getCVByMaCV(macv);
        
        request.setAttribute("cv",cv);
        request.getRequestDispatcher("suachucvu.jsp").forward(request, response);
    }
