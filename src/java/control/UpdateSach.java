 ...
 * @author ASUS
 */
@WebServlet(name = "UpdateSach", urlPatterns = {"/updateSach"})
public class UpdateSach extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateSach</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateSach at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        SACHDAO dao = new SACHDAO();
        dao.UpdateSach(masach, tensach, namxb, sl, theloai, nhaxb);
        response.sendRedirect("sachload");
    }
